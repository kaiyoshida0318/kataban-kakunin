...
- ランキングURLの登録（ジャンル名 / URL / 確認内容 / 最終確認日 / カテゴリ）
- 各ランキングの下の **＋** から、ランキング内の良かった商品URLを積んでいける
- カードの「✓ 今日確認」で最終確認日を今日に更新。`◷ 3日前` の表示が14日を超えると琥珀色になる
- タブごとの検索とカテゴリ絞り込み
- URLはクリックで別タブ、⧉ でコピー
      ...
      "items": [
        {
          ...
          "category": "カテゴリ",
          "picks": [                 // ランキング内の良かった商品URL
            { "id": "pk_xxxx", "name": "商品名・メモ", "url": "https://..." }
          ],
          "createdAt": "ISO8601",
          "updatedAt": "ISO8601"
        }
