...
最終更新: 2026-08-26 / 現行版 **v0.81.0**

次のチャットに渡すもの:

1. `katabankakuninv0.81.0full.zip`（全ファイル入り。これが唯一の正）
...
- **グループはタブごと（v0.79.0）**。`COL_GROUPS = ["amazon","rakuten","rivals","added","pick"]`、
