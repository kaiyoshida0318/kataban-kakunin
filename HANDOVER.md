...
最終更新: 2026-08-26 / 現行版 **v0.80.0**

次のチャットに渡すもの:

1. `katabankakuninv0.80.0full.zip`（全ファイル入り。これが唯一の正）
...
左から ↑↓ / 順番の数字 / ☑表示 / 項目名（15em固定） / 幅 / 揃え。番号を打ち替えるとその位置へ動く（`reorder()`）。
...
- **v0.80.0 列管理を上のタブで1つずつ選ぶ形に（■ランキング / ■展開部分）（最新）**
