...
最終更新: 2026-08-25 / 現行版 **v0.56.0**

次のチャットに渡すもの:

1. `katabankakuninv0.56.0full.zip`（全ファイル入り。これが唯一の正）
...
- **v0.56.0 列管理（表示/非表示・並び順）。amazon基準/楽天基準は共通、追加した商品は別（最新）**
